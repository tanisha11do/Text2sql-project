...
{question}
""")
# model_output_validation_prompt = PromptTemplate(
#     input_variables=["question"],
#     template="""You are an intelligent, context-aware AI assistant.
...
# def validate_model_output(question):
#     context :str = text_to_sql(question) 
#     prompt = model_output_validation_prompt.format(query=question, context= context)
#     response = llm.invoke(prompt)
#     return response.content.strip()

# print(validate_model_output(question="Which equipments are below reorder level"))
